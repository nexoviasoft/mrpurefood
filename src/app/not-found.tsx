    ...
    <div className="min-h-[70vh] flex items-center justify-center bg-gray-50/50 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full text-center space-y-8 bg-white p-10 rounded-3xl shadow-xl shadow-gray-200/50 border border-gray-100">
        ...
        <div className="pt-4">
          <Link 
            href="/"
            className="inline-flex items-center gap-2 px-8 py-3.5 bg-primary text-white text-sm font-bold rounded-xl hover:opacity-90 transition-all shadow-lg shadow-primary/10 hover:shadow-xl hover:-translate-y-0.5"
          >
