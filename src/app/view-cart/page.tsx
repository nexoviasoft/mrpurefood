      ...
      <div className="min-h-[70vh] bg-gray-50/50 flex items-center justify-center px-4">
        <ScrollAnimation>
          <div className="text-center space-y-6 max-w-md">
            ...
            <Link
              href="/products"
              className="inline-flex items-center justify-center px-8 py-3 bg-primary text-white text-sm font-bold rounded-xl hover:opacity-90 transition-all shadow-lg shadow-primary/10 hover:shadow-xl hover:-translate-y-0.5"
            >
              কেনাকাটা করুন
            </Link>
          </div>
          ...
          <div className="lg:col-span-1">
            <ScrollAnimation delay={0.2}>
              <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-5 sticky top-24">
                ...
                <Link
                  href="/checkout"
                  className="w-full flex items-center justify-center gap-2 px-6 py-3 bg-primary text-white text-sm font-bold rounded-lg hover:opacity-90 transition-all shadow-md shadow-primary/10 hover:shadow-lg hover:-translate-y-0.5"
                >
                  চেকআউট করুন
